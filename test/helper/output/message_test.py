...
def process_terminal_message(elapsed_time_ns: int, capfd: object, max_decimals: int = None, has_thread: bool = False) -> tuple[str, TimeFractions, ElapsedTimeFractions, int, str]:
...
class TestOutputMessage():
    def test_output_message_days(self, capfd: object) -> None:
        for _ in range(100):
    ...
    def test_output_message_hours(self, capfd: object) -> None:
        for _ in range(100):
    ...
    def test_output_message_minutes(self, capfd: object) -> None:
        for _ in range(100):
    ...
    def test_output_message_seconds(self, capfd: object) -> None:
        for _ in range(100):
    ...
    def test_output_message_milliseconds(self, capfd: object) -> None:
        for _ in range(100):
    ...
    def test_output_message_microseconds(self, capfd: object) -> None:
        for _ in range(100):
    ...
    def test_output_message_nanoseconds(self, capfd: object) -> None:
        for _ in range(100):
    ...
    def test_output_message_hours_with_custom_thread(self, capfd: object) -> None:
        for _ in range(100):
            mock_elapsed_time_ns = random_hours_as_ns(allow_zero = False)
