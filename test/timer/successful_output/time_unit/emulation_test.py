...
NANOSECONDS_TEST_SET_WITH_THREAD = TimeUnitEmulationTestSet(
    ...
    expected_time_unit=TimeUnit.NANOSECONDS,
    thread="custom")
...
MICROSECONDS_TEST_SET_WITH_THREAD = TimeUnitEmulationTestSet(
    time_delta_ns=microseconds_as_ns(123),
...
MILLISECONDS_TEST_SET_WITH_THREAD = TimeUnitEmulationTestSet(
    time_delta_ns=milliseconds_as_ns(123),
    expected_time_unit=TimeUnit.MILLISECONDS,
    thread="custom")
...
SECONDS_TEST_SET_WITH_THREAD = TimeUnitEmulationTestSet(
    time_delta_ns=seconds_as_ns(30),
    expected_time_unit=TimeUnit.SECONDS,
    thread="custom")
...
MINUTES_TEST_SET_WITH_THREAD = TimeUnitEmulationTestSet(
    time_delta_ns=minutes_as_ns(10),
    expected_time_unit=TimeUnit.MINUTES,
    thread="custom")
...
HOURS_TEST_SET_WITH_THREAD = TimeUnitEmulationTestSet(
    time_delta_ns=hours_as_ns(3),
    expected_time_unit=TimeUnit.HOURS,
    thread="custom")
...
def test_timer_emulated_time_unit_output(test_set: TimeUnitEmulationTestSet, capfd: object) -> None:
    ...
    expected_output_regex = successful_output_regex(thread=test_set.thread, decimals=test_set.decimals, time_unit=test_set.expected_time_unit)
