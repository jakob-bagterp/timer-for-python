class TimeFractions:
	def __init__(self, elapsed_time_ns) -> None: # Elapsed time is in nanoseconds and should be calculated as difference between start and stop time using on the time.perf_counter_ns() function. 
