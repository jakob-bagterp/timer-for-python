...
class Timer(TimerBase):
    ...
    def start(self, thread: str | None = None, decimals: int | None = None) -> None:
        ...
        Args:
            ...
            decimals (int | None, optional): Option to define decimals for output. Minimum `0` and maximum `9`. If `None`, default is `2` decimals. May be overruled in certain cases due to humanising the output.
